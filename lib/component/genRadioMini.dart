                      ...
                      return initValue == index
                          ? Container(
                              ...
                              child: GenText(
                                e[widget.id],
                                style: TextStyle(
                                    color: Colors.white, fontSize: 20.ssp),
                                textAlign: widget.leftAlign
                                    ? TextAlign.start
                                    : TextAlign.center,
                              ),
                          ...
                          : InkWell(
                              ...
                              child: Container(
                                ...
                                child: GenText(
                                  e[widget.id],
                                  style: TextStyle(
                                      color: Colors.black54, fontSize: 20.ssp),
                                  textAlign: widget.leftAlign
                                      ? TextAlign.start
                                      : TextAlign.center,
                                ),
                          ...
                          child: Column(
                            children: <Widget>[
                              ...
                              GenText(
                                ...
                                style: TextStyle(
                                    color: Colors.white, fontSize: 25.ssp),
                              ),
                              SizedBox(
                                height: 5.h,
                              ),
                              ...
                              GenText(
                                ...
                                style: TextStyle(
                                    color: Colors.white, fontSize: 28.ssp),
                              ),
                              GenText(
                                "Per Bulan",
                                style: TextStyle(color: Colors.white),
                            ...
                            child: Column(
                              children: <Widget>[
                                ...
                                GenText(
                                  formatRupiahUseprefik(e[widget.harga]) ?? "",
                                  style: TextStyle(
                                      color: Colors.black87, fontSize: 28.ssp),
                                ),
                                GenText(
                                  "Per Bulan",
